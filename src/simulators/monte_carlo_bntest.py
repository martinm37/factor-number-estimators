...
from src.computation_functions.old_3.data_generating_process_bntest import dgp_nt_correlations
...
def monte_carlo_nt(dims_tbl, iter_num, burning_period, r, theta, rho, beta, k_max, simulation_seed):
    ...
    for x in range(0, dims_length):
        ...
        for e in range(0, iter_num):
            ...
            X_raw = dgp_nt_correlations(Lambda = Lambda, N = dims_tbl[x, 0], T = dims_tbl[x, 1],
                                    ...
                                    r = r, theta = theta, rho = rho, beta = beta, J = J,
                                    rng = rng)
