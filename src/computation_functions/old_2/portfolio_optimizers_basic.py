...
def portfolio_optimizer_poet_er(daily_returns,training_sample_width,out_of_sample_width):
    ...
    for t in range(iter_num):
        ...
        K = ER_fun(training_sample,(1 / (N * T)) * eigen_val_sort, k_max=8)[1]
    ...
    return daily_returns_vec, k_estimate_vec
...
def portfolio_optimizer_poet_ic1(daily_returns,training_sample_width,out_of_sample_width):
