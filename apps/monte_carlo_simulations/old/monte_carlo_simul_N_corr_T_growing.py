...
np.save("output_cube_Ncorr_T_large",output_cube_Ncorr)

avg_result_Ncorr = np.mean(output_cube_Ncorr,axis=2,keepdims=False)

results_Ncorr_df = df_maker(input_tbl,avg_result_Ncorr)

results_Ncorr_df.to_csv("results_Ncorr_T_large.csv", sep=",", index=False)
