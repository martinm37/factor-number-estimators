...
with open(os.path.join(get_results_path(),"mc_run_log.txt"), "a") as text_file:
    print("log file for _Ncorr_T_large", file = text_file)
...
np.save(os.path.join(get_results_path(),"output_cube_Ncorr_T_large"),output_cube_Ncorr)
...
results_Ncorr_df.to_csv(os.path.join(get_results_path(),"results_Ncorr_T_large.csv"), sep=",", index=False)
...
os.rename(os.path.join(get_results_path(),"mc_run_log.txt"),
          os.path.join(get_results_path(),"mc_run_log_Ncorr_T_large.txt"))
