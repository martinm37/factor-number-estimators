...
with open(os.path.join(get_results_path(),"mc_run_log.txt"), "a") as text_file:
    print("log file for _Tcorr_N_large", file = text_file)
...
np.save(os.path.join(get_results_path(),"output_cube_Tcorr_N_large"),output_cube_Tcorr)
...
results_Tcorr_df.to_csv(os.path.join(get_results_path(),"results_Tcorr_N_large.csv"), sep=",", index=False)
...
os.rename(os.path.join(get_results_path(),"mc_run_log.txt"),
          os.path.join(get_results_path(),"mc_run_log_Tcorr_N_large.txt"))
